...
00000000004021c9 <urlencode>:
  ...
  4021ee:	f2 ae                	repnz scas (%rdi),%al
...
00000000004022d6 <submitr>:
  ...
  402583:	f3 48 ab             	rep stos %rax,(%rdi)
  ...
  402666:	f2 ae                	repnz scas (%rdi),%al
  ...
  4029ab:	f3 a6                	repz cmpsb (%rdi),(%rsi)
