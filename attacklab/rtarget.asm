...
00000000004022e9 <urlencode>:
  ...
  40230e:	f2 ae                	repnz scas (%rdi),%al
...
00000000004023f6 <submitr>:
  ...
  4026a3:	f3 48 ab             	rep stos %rax,(%rdi)
  ...
  402786:	f2 ae                	repnz scas (%rdi),%al
  ...
  402acb:	f3 a6                	repz cmpsb (%rdi),(%rsi)
